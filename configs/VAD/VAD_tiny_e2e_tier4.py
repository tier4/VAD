"""
VAD tiny end-to-end training with Tier4 coordinate system.

This configuration uses the Tier4 ego-centered coordinate system which is
already implemented in the original VADCustomNuScenesDataset.

The coordinate transformation (Y->X, -X->Y) is hardcoded in the dataset.
"""
...
# =============================================================================
# The VADCustomNuScenesDataset uses Tier4 ego-centered coordinates
# with the transformation (Y->X, -X->Y) hardcoded in the dataset implementation

# Tier4 ego-centered coordinates
point_cloud_range = [-30.0, -16.0, -0.16, 30.0, 16.0, 3.84]
# Post-processing center range for filtering predictions
detection_post_center_range = [-35.0, -21.0, -0.66, 35.0, 21.0, 4.34]
# For map elements (8 values: x_min, y_min repeated)
...
# =============================================================================
dataset_type = 'VADCustomNuScenesDatasetTier4'
