...
class CustomCollect3D(object):
    ...
    def __init__(self,
                 ...
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                            ...
                            'transformation_3d_flow', 'scene_token', 'folder',
                            'can_bus',
                            )):
        self.keys = keys
...
class CustomObjectRangeFilter(ObjectRangeFilter):
    def __call__(self, results):
        ...
        if 'attr_labels' in results:
            gt_attr_labels = results['attr_labels']
            gt_attr_labels = gt_attr_labels[mask.numpy().astype(np.bool)]
            results['gt_attr_labels'] = gt_attr_labels
...
class CustomObjectNameFilter(ObjectNameFilter):
    def __call__(self, results):
        ...
        if 'gt_attr_labels' in results:
            results['gt_attr_labels'] = results['gt_attr_labels'][gt_bboxes_mask]
